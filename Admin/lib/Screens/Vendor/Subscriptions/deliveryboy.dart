...
class DelivermanSub extends StatefulWidget {
  String document;
  DelivermanSub(this.document);

  @override
  _DelivermanSubState createState() => _DelivermanSubState();
}

class _DelivermanSubState extends State<DelivermanSub> {
                        ...
                        children: snapshot.data!.docs.map((DocumentSnapshot document) {
                          ...
                          return ListTile(
                            onTap: (){
                              ...
                              _services.selectDeliveryManForSubscription(widget.document, data['name'], data['mobile'].toString()).then((value) {
