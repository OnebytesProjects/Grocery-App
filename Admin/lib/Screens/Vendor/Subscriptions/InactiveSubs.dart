...
class InActiveSubscription extends StatefulWidget {
  static const String id = 'subscription-screen';

  @override
  State<InActiveSubscription> createState() => _InActiveSubscriptionState();
}

class _InActiveSubscriptionState extends State<InActiveSubscription> {
    ...
    return Scaffold(
      ...
      body: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream: orderService.subscription.where('orderStatus',isEqualTo: 'SubScription Ended').snapshots(),
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (BuildContext context,int index){
                              return ListTile(
                                ...
                                subtitle: Text('Quantity: ${data['products'][index]['qty'].toString()}    Price:₹${data['total'].toString() }  Volume:${data['products'][index]['productVolume'].toString()}  Delivery Period:${data['products'][index]['subscription'].toString()}',
