    ...
    return Scaffold(
      ...
      body: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream: orderService.order.where(
              'orderStatus', isEqualTo: 'Delivered').snapshots(),
                    ...
                    children: [
                      ...
                      ListTile(
                        leading: CircleAvatar(
                            ...
                            radius: 14,
                            child: Icon(
                              CupertinoIcons.profile_circled, size: 18,
                              color: Colors.grey,)
                        ),
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return ListTile(
                                ...
                                subtitle: Text(
                                  'Quantity: ${data['products'][index]['qty']
                                      .toString()}   Price:₹ ${data['products'][index]['sellingPrice']
                                      .toString()} Volume: ${data['products'][index]['productVolume']
                                      .toString()}',
                                  style: TextStyle(
                      ...
                      tasks(
                          ...
                          document,
                          document.id,
                          data['deliverBoy']['name'],
                          data['deliverBoy']['phone'],
                          data,
                          context),
                      //checking
